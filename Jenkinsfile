...
node {
    ...
    stage('Access AWS EC2 instance') {
        ...
        // sh "ssh -i /var/lib/jenkins/workspace/jenkins-ubuntu/key1.pem ubuntu@ec2-3-0-61-6.ap-southeast-1.compute.amazonaws.com"
        sh "ssh -i /Home/Downloads/key1.pem ubuntu@ec2-3-0-61-6.ap-southeast-1.compute.amazonaws.com"
